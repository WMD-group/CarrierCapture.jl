...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(formatter_class=argparse.RawTextHelpFormatter,
                                     description="This script interpolates coordinates of intermediate structures on a line between equivalent atoms of initial and final structures and generates POSCAR files.")
